...
def train(config, model, train_iter, dev_iter, test_iter, logger):
    ...
    for epoch in range(config.num_epochs):
        ...
        for i, (trains, labels) in enumerate(train_iter):
            ...
            if total_batch % 100 == 0:
                ...
                logger.info("loss/train: " + str(loss.item()) + ' / ' + str(total_batch))
                logger.info("loss/dev: " + str(dev_loss) + ' / ' + str(total_batch))
                logger.info("acc/train: " + str(train_acc) + ' / ' + str(total_batch))
                logger.info("acc/dev: " + str(dev_acc) + ' / ' + str(total_batch))
                model.train()
            total_batch += 1
